...
class UserPreferences with _$UserPreferences {
  const factory UserPreferences({
    ...
    @Default(DotubeColor(0xFF2196F3, name: "Blue"))
    @JsonKey(
  ...
  static DotubeColor _accentColorSchemeFromJson(Map<String, dynamic> json) {
    return DotubeColor.fromString(json["color"]);
  }

  static Map<String, dynamic>? _accentColorSchemeReadValue(Map<dynamic, dynamic> json, String key) {
  ...
  static Map<String, dynamic> _accentColorSchemeToJson(DotubeColor color) {
  ...
  static Map<String, dynamic>? _localeReadValue(Map<dynamic, dynamic> json, String key) {
    if (json[key] is String) {
