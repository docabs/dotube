...
import 'package:dotube/components/settings/color_scheme_picker_dialog.dart';

// import 'package:dotube/provider/palette_provider.dart';
// import 'package:dotube/provider/proxy_playlist/player_listeners.dart';
// import 'package:dotube/provider/proxy_playlist/proxy_playlist_provider.dart';
import 'package:dotube/provider/user_preferences/user_preferences_state.dart';

// import 'package:dotube/services/audio_player/audio_player.dart';
import 'package:dotube/services/sourced_track/enums.dart';
...
class UserPreferencesNotifier extends PersistedStateNotifier<UserPreferences> {
  ...
  UserPreferencesNotifier(this.ref) : super(UserPreferences.withDefaults(), "preferences");
  ...
  void setAccentColorScheme(DotubeColor color) {
  ...
  Future<String> _getDefaultDownloadDirectory() async {
    if (kIsAndroid) return "/storage/emulated/0/Download/Dotube";
    ...
    return getDownloadsDirectory().then((dir) {
      return path.join(dir!.path, "Dotube");
    });
  }
