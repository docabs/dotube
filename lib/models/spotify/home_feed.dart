...
class SpotifyHomeFeed with _$SpotifyHomeFeed {
  ...
  factory SpotifyHomeFeed.fromJson(Map<String, dynamic> json) => _$SpotifyHomeFeedFromJson(json);
}

Map<String, dynamic> transformSectionItemTypeJsonMap(Map<String, dynamic> json) {
...
Map<String, dynamic> transformSectionItemJsonMap(Map<String, dynamic> json) {
  return {
    ...
    "items": (json["sectionItems"]["items"] as List)
        .map(
          (data) => transformSectionItemTypeJsonMap(data as Map<String, dynamic>) as dynamic,
        )
        .where(
          (w) => w["playlist"] != null || w["artist"] != null || w["album"] != null,
        )
        .toList()
        .cast<Map<String, dynamic>>()
  };
...
Map<String, dynamic> transformHomeFeedJsonMap(Map<String, dynamic> json) {
  return {
    ...
    "sections": (json["data"]["home"]["sectionContainer"]["sections"]["items"] as List)
        .map(
          (item) => transformSectionItemJsonMap(item as Map<String, dynamic>) as dynamic,
        )
        .toList()
        .cast<Map<String, dynamic>>()
  };
