...
class SpotifyFriend {
  ...
  factory SpotifyFriend.fromJson(Map<String, dynamic> json) => _$SpotifyFriendFromJson(json);
...
class SpotifyFriends {
  ...
  factory SpotifyFriends.fromJson(Map<String, dynamic> json) => _$SpotifyFriendsFromJson(json);
}
